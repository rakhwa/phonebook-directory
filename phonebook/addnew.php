...
if(isset($_POST['submit'])){
  ...
  if($name == '' || $designation == ''  || $phone == ''  || $address == ''){
...

    {
        ...
        $sql = "INSERT INTO contact(name, designation, phone, address,user_id) VALUES ('$name','$designation','$phone', '$address', '$user_id')";
        $result = $connection->query($sql);
     if($result == TRUE){
      $message = '<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Success!</strong> Contact added successfully</div>'; 
      }
        else  
        {
...
<?php include 'menu.php' ?>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-6">
                    <div class="card pb-4">
                        <div class="card-header text-center"><h4 class="text-info">Add New Contact</h4></div>
                        <div class="card-body mt-4">

                            <?php echo $message ?>
                            <form name="my-form" onsubmit="return validform()" action="<?php echo ($_SERVER["PHP_SELF"]);?>" method="POST">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right text-info">Name<span class="text-danger">*</span></label>
                                    <div class="col-md-6">
